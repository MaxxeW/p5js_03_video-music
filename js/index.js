...
var
  ColorMapper = function () {
    ...
    _createClass(ColorMapper, [{
      ...
      key: '_easeVals',
      value: function _easeVals(

        prev, next) {
        var ease = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.025;
        if (!prev) return next;
